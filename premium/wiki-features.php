...
class Wiki_Features {
	...
	public static function get_instance() {
		if ( is_null(self::$_instance) ) {
			self::$_instance = new Wiki_Features();
		}
...
<tr valign="top">
	...
	public function save_settings( $settings, $postdata ) {
		$settings['breadcrumbs_in_title'] = isset($postdata['breadcrumbs_in_title']) ? intval($postdata['breadcrumbs_in_title']) : 0;
		$settings['wiki_name'] = isset($postdata['wiki_name']) ? $postdata['wiki_name'] : $settings['wiki_name'];
		$settings['sub_wiki_name'] = isset($postdata['sub_wiki_name']) ? $postdata['sub_wiki_name'] : $settings['sub_wiki_name'];
		$settings['sub_wiki_order_by'] = isset($postdata['sub_wiki_order_by']) ? $postdata['sub_wiki_order_by'] : $settings['sub_wiki_order_by'];
		$settings['sub_wiki_order'] = isset($postdata['sub_wiki_order']) ? $postdata['sub_wiki_order'] : $settings['sub_wiki_order'];
		return $settings;
	}
